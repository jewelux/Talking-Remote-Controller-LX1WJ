# Hardware Wiring Reference (ESP32 Talking Remote Controller - V3.5.4)

This document describes the hardware wiring used by the current modular repository state based on
`firmware/TalkingRemoteControllerLX1WJ_V3_5_4.ino`.
...
- This document reflects the current V3.5.4 repository state.
