# Hardware Wiring Reference (ESP32 Talking Remote Controller - V3.5.5)

This document describes the hardware wiring used by the current modular repository state based on
`firmware/TalkingRemoteControllerLX1WJ_V3_5_5.ino`.
...
| Pin | Keypad Signal | ESP32-S3 GPIO |
|---|---|---|
|1| ROW1 | GPIO 4 |
|2| ROW2 | GPIO 8 |
|3| ROW3 | GPIO 15 |
...
- This document reflects the current V3.5.5 repository state.
